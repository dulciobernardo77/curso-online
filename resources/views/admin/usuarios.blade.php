...
<head>
    ...
    <title>Usuários - Admin SpaceSeat</title>
        ...
        <div class="min-vh-100 d-flex">
            ...
            <aside class="py-4 px-3" style="width: 180px;" id="sidebar">
                ...
                <nav>
                    ...
                    <a href="/admin/usuarios" class="nav-link active mb-1">
            ...
            <main class="flex-grow-1 py-4 px-4">
                <div class="mx-auto" style="max-width: 1200px;">
                    ...
                    <header class="mb-5 d-flex justify-content-between align-items-center">
                        <h1 class="fs-5 fw-medium m-0">Gerenciar Usuários</h1>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm bg-dark text-white border-secondary" placeholder="Nome ou email...">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-warning">Instrutor</span></td>
                                            <td><span class="badge badge-success">Ativo</span></td>
                                            <td>22/03/2024</td>
                                            <td>
                                                <button class="btn btn-subtle btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-secondary">Aluno</span></td>
