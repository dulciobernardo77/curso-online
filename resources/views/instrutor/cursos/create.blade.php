...
<head>
    ...
    <title>Criar Curso - SpaceSeat</title>
                ...
                <div class="mx-auto" style="max-width: 800px;">
                    ...
                    <header class="mb-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                <h1 class="fs-5 fw-medium m-0">Criar Novo Curso</h1>
                                <p class="text-secondary fs-small mt-1 mb-0">Preencha os campos abaixo para criar seu curso</p>
                            </div>
                        </div>
                    </header>

                    <!-- Formulário de criação de curso -->
                    <form action="{{ route('instrutor.cursos.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" min="1" class="form-control @error('duration_hours') is-invalid @enderror" id="duration_hours" name="duration_hours" value="{{ old('duration_hours') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                                            ...
                                            <option value="review" {{ old('status') == 'review' ? 'selected' : '' }}>Em Revisão</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="d-flex justify-content-end gap-2 mb-5">
                            <a href="{{ route('instrutor.cursos.index') }}" class="btn btn-outline-accent">Cancelar</a>
                            <button type="submit" class="btn btn-accent">Criar Curso</button>
                        </div>
                    </form>
                </div>
            </main>
